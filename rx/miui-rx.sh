...
# clang stuff
		...
		git clone --depth=1 https://github.com/Neutron-Toolchains/neutron-clang.git -b Neutron-14 "$HOME"/clang
...
tg_post_msg "Compile Kernel sedang berlangsung untuk $DEVICE - MIUI-RX VERSION" "$CHATID"
